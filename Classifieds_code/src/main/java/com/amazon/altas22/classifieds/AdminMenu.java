            ...
            while(true) {
                ...
                switch (choice) {
                    ...
                    case 5:
                        ...
                        System.out.println("1: Total number of Classifieds");
                        System.out.println("2: Total sales number and net");
                        System.out.println("3: Sales between the dates range");
                        System.out.println("4: List all Inactive user accounts");
                        System.out.println("5. List all rejected classifieds");
                        choice = Integer.parseInt(scanner.nextLine());
